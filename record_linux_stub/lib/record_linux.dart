...
/// Local stub of RecordLinux that adds startStream for record_platform_interface >=1.4.0.
/// The startStream method throws UnimplementedError since Linux streaming is not supported.
class RecordLinux extends RecordPlatform {
  ...
  /// Streaming recording is not supported on Linux in this stub.
  @override
  Future<Stream<Uint8List>> startStream(
      String recorderId, RecordConfig config) async {
    throw UnimplementedError(
        'startStream is not supported on Linux. Use start() instead.');
  }
  ...
  Future<List<InputDevice>> _listInputDevices(
      String recorderId, List<String> out) async {
