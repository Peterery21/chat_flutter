...
class _$ChatUserImpl implements _ChatUser {
  ...
  @override
  String toString() {
    return 'ChatUser(id: $id, userId: $userId, username: $username, avatar: $avatar, online: $online, lastSeen: $lastSeen)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, username, avatar, online, lastSeen);
